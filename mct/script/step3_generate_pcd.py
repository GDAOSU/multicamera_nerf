...
def generate_pcd_single_tile(trained_model_dir,block_id,timestamp,num_pts,out_dir,skip_img=2):
    if not os.path.exists(out_dir):
        os.mkdir(out_dir)
    #trained_blocks=glob.glob(os.path.join(trained_model_dir,"*"))
...
if __name__=='__main__':
    # generate_pcd_single_tile(r'J:\xuningli\cross-view\ns\nerfstudio\outputs\demo_dortmund_metashape_center',0,'60000',1000000,
    #                          r'J:\xuningli\cross-view\ns\nerfstudio\pcd\demo_dortmund_metashape_center')
    # generate_pcd_single_tile(r'J:\xuningli\cross-view\ns\nerfstudio\outputs\demo_dortmund_metashape_center_old',0,'60000',1000000,
    #                         r'J:\xuningli\cross-view\ns\nerfstudio\pcd\demo_dortmund_metashape_center_old')
    generate_pcd_single_tile(r'J:\xuningli\cross-view\ns\nerfstudio\outputs\demo_usc_area1',0,'60000',1000000,
                            r'J:\xuningli\cross-view\ns\nerfstudio\pcd\demo_usc_area1')
